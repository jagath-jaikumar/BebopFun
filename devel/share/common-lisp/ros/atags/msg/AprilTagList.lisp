...
(cl:defclass <AprilTagList> (roslisp-msg-protocol:ros-message)
  ((april_tags
    :reader april_tags
    :initarg :april_tags
    :type (cl:vector atags-msg:AprilTag)
   :initform (cl:make-array 0 :element-type 'atags-msg:AprilTag :initial-element (cl:make-instance 'atags-msg:AprilTag))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atags-msg:<AprilTagList> is deprecated: use atags-msg:AprilTagList instead.")))

(cl:ensure-generic-function 'april_tags-val :lambda-list '(m))
(cl:defmethod april_tags-val ((m <AprilTagList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atags-msg:april_tags-val is deprecated.  Use atags-msg:april_tags instead.")
  (april_tags m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'april_tags)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'atags-msg:AprilTag))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AprilTagList>)))
  ...
  (cl:format cl:nil "AprilTag[] april_tags~%================================================================================~%MSG: atags/AprilTag~%uint32 	id~%uint32 	hamming_distance~%float64 distance~%float64 x~%float64 y~%float64 z~%float64 yaw~%float64 pitch~%float64 roll~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AprilTagList)))
  "Returns full string definition for message of type 'AprilTagList"
  (cl:format cl:nil "AprilTag[] april_tags~%================================================================================~%MSG: atags/AprilTag~%uint32 	id~%uint32 	hamming_distance~%float64 distance~%float64 x~%float64 y~%float64 z~%float64 yaw~%float64 pitch~%float64 roll~%~%"))
